...
Description
    Multiphysics solver for alkaline water electrolyzer cells with porous-
    electrode electrochemistry, species transport and two-phase drift-flux
    flow. Gas generation is coupled to bubble mass transfer and coverage.

Reference
    A.N. Jacobsen et al., Electrochimica Acta 541 (2025) 147148.
...
int main(int argc, char *argv[])
{
    ...
    while (runTime.run())
    {
        ...
        // Update vapour pressure before evaluating mixture properties.
        ...
        {	
            ...
            // Couple concentration losses, electrode potentials and species.
