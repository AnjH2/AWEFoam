...
{
    theta_ =(J_scale_*pow(mag(J_)/(as_*J_lim_),0.3))*pow(T_/T_ref_*dimensionedScalar(dimPressure,101325)/p_num_,2/3);//Numerical modeling and analysis of the effect of pressure on the performance of an alkaline water electrolysis system 
