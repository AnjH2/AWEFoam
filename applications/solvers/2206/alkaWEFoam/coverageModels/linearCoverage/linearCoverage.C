...
{
    defineTypeNameAndDebug(linearCoverage, 0);
    addToRunTimeSelectionTable(coverageModel, linearCoverage, dictionary);
}
}
...
{
    // Generalized linear coverage correlation; cap gas fraction below unity.
