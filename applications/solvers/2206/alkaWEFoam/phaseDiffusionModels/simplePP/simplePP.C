...
{
    defineTypeNameAndDebug(simplePP, 0);
    addToRunTimeSelectionTable(phaseDiffusionModel, simplePP, dictionary);
}
}
...
Foam::phaseDiffusionModels::simplePP::simplePP
(
...
volScalarField Foam::phaseDiffusionModels::simplePP::f()
{
	
	return aL_*pow(1-alphad_,bP_)+cL_*pow(alphad_,dP_);
}

volVectorField Foam::phaseDiffusionModels::simplePP::vStokes()
{
...
volTensorField Foam::phaseDiffusionModels::simplePP::UHdiff()
{
...
void Foam::phaseDiffusionModels::simplePP::correct()
{
