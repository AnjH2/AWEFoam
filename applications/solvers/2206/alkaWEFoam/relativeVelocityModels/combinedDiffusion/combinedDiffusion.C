...
{
    defineTypeNameAndDebug(combinedDiffusion, 0);
    addToRunTimeSelectionTable(relativeVelocityModel, combinedDiffusion, dictionary);
}
}
...
Foam::relativeVelocityModels::combinedDiffusion::combinedDiffusion
(
...
// * * * * * * * * * * * * * * Private Functions  * * * * * * * * * * * * * * //
volScalarField Foam::relativeVelocityModels::combinedDiffusion::f()
{
	
	return pow(1-min(alphad_,minAlphad_),n_);
}

dimensionedVector Foam::relativeVelocityModels::combinedDiffusion::vStokes(int j)
{
...
volVectorField Foam::relativeVelocityModels::combinedDiffusion::UStokes(int j)
{
