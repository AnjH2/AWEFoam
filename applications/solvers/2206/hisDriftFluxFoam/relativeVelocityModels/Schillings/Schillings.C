...
namespace relativeVelocityModels
{
    ...
    addToRunTimeSelectionTable(relativeVelocityModel, Schillings, dictionary);
}
}
...
Foam::relativeVelocityModels::Schillings::Schillings
(
...
volScalarField Foam::relativeVelocityModels::Schillings::kappa()
{
	
	return 0.6*pow(alphad_,2);
}

volScalarField Foam::relativeVelocityModels::Schillings::beta()
{
	
	return 1/3*pow(alphad_,2)*(1+0.5*exp(8.8*alphad_));
}

volScalarField Foam::relativeVelocityModels::Schillings::f()
{
...
volVectorField Foam::relativeVelocityModels::Schillings::UStokes()
{
...
void Foam::relativeVelocityModels::Schillings::correct()
{
	
	

    Udm_ = (UStokes()+USmig()+USaff())*(rhoc_/rho());//+USmig()+USaff()
