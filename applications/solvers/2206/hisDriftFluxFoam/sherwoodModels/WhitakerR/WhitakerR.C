...
{
    defineTypeNameAndDebug(WhitakerR, 0);
...
Foam::sherwoodModels::WhitakerR::WhitakerR
(
    const word& name,
...
bool Foam::sherwoodModels::WhitakerR::read
(
    const dictionary& sherwoodPropertiesSub1
)
{
    ...
    WhitakerRCoeffsSub1_ = sherwoodPropertiesSub1.optionalSubDict(typeName + "Coeffs");

    //WhitakerRCoeffsSub1_.readEntry("mu", mud_);
  //  WhitakerRCoeffs_.readEntry("n", WhitakerRsherwoodExponent_);
   // WhitakerRCoeffs_.readEntry("muMax", muMax_);
